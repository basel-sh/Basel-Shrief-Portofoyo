...
export const galleryItems: GalleryItem[] = [
  ...
  {
    id: "poland-ceremony",
    src: "/assets/images/competitions/poland-award-ceremony.jpg",
    label: "Poland — Award Ceremony",
    span: "square",
  },
  {
    id: "poland-team",
    src: "/assets/images/competitions/poland-eco-racing-team.jpg",
    label: "Poland — Eco Racing Team",
    span: "tall",
  },
  {
    id: "poland-car",
    src: "/assets/images/competitions/poland-race-car.jpg",
    label: "Poland — Race Car",
    span: "wide",
  },
  {
    id: "qatar-ceremony",
    src: "/assets/images/competitions/qatar-award-ceremony.jpg",
    label: "Qatar — Award Ceremony",
    span: "square",
  },
  {
    id: "qatar-group",
    src: "/assets/images/competitions/qatar-team-photo.jpg",
    label: "Qatar — Team Photo",
    span: "wide",
  },
  {
    id: "qatar-car",
    src: "/assets/images/competitions/qatar-race-car.jpg",
    label: "Qatar — Race Car",
    span: "tall",
  },
  {
    id: "smart-watch",
